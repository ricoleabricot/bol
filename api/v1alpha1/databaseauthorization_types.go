...
type DatabaseAuthorizationSpec struct {
	...
	// Foo is an example field of DatabaseAuthorization. Edit DatabaseAuthorization_types.go to remove/update
...
// DatabaseAuthorization is the Schema for the databaseauthorizations API
