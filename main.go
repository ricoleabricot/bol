...
func init() {
	...
	_ = containersv1alpha1.AddToScheme(scheme)
...
func main() {
	...
	if err = (&authorization.DatabaseAuthorizationReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("DatabaseAuthorization"),
